import { ITerminalGameIo, ITerminalGameIoOptions } from '..';
import { AbstractTerminalGameIo } from './abstract-terminal-game-io';
export declare class TerminalGameIoBrowser extends AbstractTerminalGameIo implements ITerminalGameIo {
