...
export declare type AbstractFrameHandler = (instance: IAbstractTerminalGameIo) => void;
export declare type AbstractKeypressHandler = (instance: IAbstractTerminalGameIo, keyName: KeyName) => void;
